...
<body class="container mt-4">
    <h2>ตะกร้าสินค้า</h2>
    <a href="indexmember.php" class="btn btn-secondary mb-3">← กลับไปเลือกสินค้า</a> <!-- TODO: หน้า index -->

    <?php if (count($items) === 0): ?>
        <div class="alert alert-warning">ข้อความกรณีตะกร้าว่าง</div> <!-- TODO: ข้อความกรณีตะกร้าว่าง -->
    <?php else: ?>
